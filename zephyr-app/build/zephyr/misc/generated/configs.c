...
GEN_ABSOLUTE_SYM(CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC, 100000000);
GEN_ABSOLUTE_SYM(CONFIG_NUM_IRQS, 12);
...
GEN_ABSOLUTE_SYM(CONFIG_BOARD_LITEX_VEXRISCV, 1);
GEN_ABSOLUTE_SYM(CONFIG_SOC_RISCV32_LITEX_VEXRISCV, 1);
GEN_ABSOLUTE_SYM(CONFIG_ARCH, 1);
GEN_ABSOLUTE_SYM(CONFIG_RISCV, 1);
GEN_ABSOLUTE_SYM(CONFIG_ARCH_IS_SET, 1);
GEN_ABSOLUTE_SYM(CONFIG_SRAM_SIZE, 262144);
GEN_ABSOLUTE_SYM(CONFIG_SRAM_BASE_ADDRESS, 0x40000000);
...
GEN_ABSOLUTE_SYM(CONFIG_UART_LITEUART, 1);
GEN_ABSOLUTE_SYM(CONFIG_VEXRISCV_LITEX_IRQ, 1);
GEN_ABSOLUTE_SYM(CONFIG_LITEX_TIMER, 1);
...
GEN_ABSOLUTE_SYM(CONFIG_MINIMAL_LIBC_MALLOC_ARENA_SIZE, 128);
